...
class TestStage7SummaryGolden(unittest.TestCase):
    ...
    def test_honor_does_not_become_domestic_other_income(self):
        ...
        self.assertEqual(
            self.page.pph_auto_values["penghasilan_neto_lainnya"].text(), "0"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.page.pph_auto_values["pkp_simulasi"].text(), "689.920.000"
        )
        self.assertEqual(
            self.page.pph_auto_values["pph_terutang"].text(), "150.976.000"
        )
